...
/**
 *  Problem 25. Kth Smallest Product of Two Sorted Arrays.
 *
 *  ## Intuition -
 *
 *  ## Approach -
...
fun main() {
    ...
    val testCases = listOf(
        Triple(intArrayOf(2, 5), intArrayOf(3, 4), 2L)
    )

    testCases.forEach { (nums1, nums2, k) ->
        println("Result ==> ${kthSmallestProduct(nums1, nums2, k)}")
    }
